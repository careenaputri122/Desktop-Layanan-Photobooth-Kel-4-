...
public class KelolaPaketController {
    ...
    @FXML private TableColumn<Paket, String> colKeterangan;
    ...
    private void setupTable() {
        // DIUBAH: dari CONSTRAINED_RESIZE_POLICY_ALL_COLUMNS
        tablePaket.setColumnResizePolicy(TableView.UNCONSTRAINED_RESIZE_POLICY);
        ...
        colKeterangan.setCellValueFactory(data ->
            new javafx.beans.property.SimpleStringProperty(nullToDash(data.getValue().getKeterangan()))
        );
        ...
        colAksi.setCellFactory(col -> new TableCell<>() {
...

            {
                ...
                btnEdit.setMinWidth(44);
                btnDelete.setMinWidth(52);
    ...
    private void pilihPaket(Paket paket) {
        ...
        fieldKeterangan.setText(paket.getKeterangan());
