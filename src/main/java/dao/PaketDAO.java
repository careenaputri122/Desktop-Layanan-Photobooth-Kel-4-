...
public class PaketDAO extends BaseDao implements IDao<Paket> {
    ...
    private void ensureKeteranganColumn() {
        String checkSql =
            "SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS " +
            "WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'paket' AND COLUMN_NAME = 'keterangan'";
        String alterSql = "ALTER TABLE paket ADD COLUMN keterangan TEXT NULL AFTER tipe";
